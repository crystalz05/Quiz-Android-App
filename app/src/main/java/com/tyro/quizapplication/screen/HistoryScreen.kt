                        ...
                        Box(
                            ...
                            Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()
                                ...
                                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                    Text("Mathematics", fontWeight = FontWeight.SemiBold, fontSize = 18.sp)
                                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                                        Text("2h ago", fontSize = 14.sp, color = Color.Gray)
                                        Text("15/20 correct", fontSize = 14.sp)
                                    }
                                }
                                Box(modifier = Modifier.background(color = colorResource(id = R.color.green_500).copy(alpha = 0.2f),
                                    shape = RoundedCornerShape(16.dp)).padding(vertical = 4.dp, horizontal = 8.dp)
                                    ){
                                    Text("85%", color = colorResource(id = R.color.green_700), fontWeight = FontWeight.SemiBold, fontSize = 16.sp)
                                }
                            }
                        }
                    }
